...
class __TwigTemplate_09bed17dcf6938b4f12370ff75648bfe3aa19eba8ada901fcd22c6ceba19787a extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 30, "if" => 43, "block" => 51];
        $filters = ["clean_class" => 33, "clean_id" => 38, "escape" => 39, "without" => 39];
        $functions = [];
    ...
    {
        // line 30
        $context["classes"] = [0 => "block", 1 => "block-search", 2 => ("block-config-provider--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed($this->getAttribute(        // line 33
($context["configuration"] ?? null), "provider", [])))), 3 => ("block-plugin-id--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(        // line 34
...
($context["label"] ?? null)) ? ("has-title") : (""))];
        ...
        // line 39
        echo "<div";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->withoutFilter($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method")), "aria-labelledby"), "html", null, true);
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        // line 52
        echo "<div";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["content_attributes"] ?? null), "addClass", [0 => "block__content", 1 => "block-search__content"], "method")), "html", null, true);
        echo ">";
        // line 53
    ...
    {
        return array (  108 => 54,  106 => 53,  102 => 52,  99 => 51,  93 => 57,  91 => 51,  89 => 49,  83 => 48,  79 => 47,  76 => 44,  74 => 43,  63 => 39,  61 => 38,  59 => 35,  58 => 34,  57 => 33,  56 => 30,);
    }
    ...
    {
        return new Source("", "themes/adaptivetheme/at_core/templates/block/block--search-form-block.html.twig", "C:\\xampp\\htdocs\\projecten3\\themes\\adaptivetheme\\at_core\\templates\\block\\block--search-form-block.html.twig");
    }
}
